...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-034-covering-squares-with-sumsets-054c6503-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-034"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-034-covering-squares-with-sumsets-054c6503-v1",
      "problem_contract_sha256": "ae5c4fbd128d509f5140d4db1319f774b1fc48974efb39859dea5bb21c5b9efb",
      "problem_id": "problem:um-green-034-covering-squares-with-sumsets-054c6503",
      "route_id": "route:um-green-034-covering-squares-with-sumsets-054c6503-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-034-covering-squares-with-sumsets-054c6503-source-fidelity-01",
      "graph_id": "graph:um-green-034-covering-squares-with-sumsets-054c6503-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-034-covering-squares-with-sumsets-054c6503-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-034-covering-squares-with-sumsets-054c6503-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Suppose $A + A$ contains the first $n$ squares. Is $|A| \\geq n^{1-o(1)}$?"
          },
          "statement_sha256": "9ca6b8198048877ede0685a76b4dc644a751fb5e8314a38c5bfeaa78ccbfc587"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-034-covering-squares-with-sumsets-054c6503-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-034-covering-squares-with-sumsets-054c6503-root",
      "route_id": "route:um-green-034-covering-squares-with-sumsets-054c6503-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-034-595f49d4cc08",
        "url": "https://www.unsolvedmath.com/problems/GREEN-034"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
